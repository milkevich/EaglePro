...
import { IPickerCancelEvent, IPickerChangeEvent, IPickerCloseEvent, IPickerOpenEvent, IPickerProps, IPickerTempChangeEvent } from '../../../core/shared/picker/picker.types';
...
export interface MbscDatepickerOptions extends MbscDatetimeOptions, MbscCalendarOptions<DatepickerBase>, IPickerProps<DatepickerBase> {
    /** @hidden */
    clearIcon?: string;
    /** @hidden */
